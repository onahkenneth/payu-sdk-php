...
class Capture extends ResourceModel
{
    ...
    /**
     * The amount to capture. If the amount matches the orginally authorized amount,
     * the state of the authorization changes to `captured`. If not, the state of the
     * authorization changes to `partially_captured`.
     *
    ...
    /**
     * The amount to capture. If the amount matches the orginally authorized amount,
     * the state of the authorization changes to `captured`. If not, the state of
     * the authorization changes to `partially_captured`.
     *
    ...
    /**
     * The date and time of capture, as defined in
    ...
    /**
     * Refund a captured payment by passing the capture_id in the request URI.
