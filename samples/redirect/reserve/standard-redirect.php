...
$redirect->setIntent(Transaction::TYPE_RESERVE)
...
try {
    ...
    ResultPrinter::printError('Setup Redirect (Reserve). If 500 Exception, try creating a new Redirect Payment transaction', 'Redirect', null, $request, $ex);
    exit(1);
}
...
// NOTE: PLEASE DO NOT USE RESULTPRINTER CLASS IN YOUR ORIGINAL CODE. FOR SAMPLE ONLY
ResultPrinter::printResult("Setup Redirect (Reserve). Please visit the URL to Capture your payment details.", "Redirect", "<a href='$rppUrl' >$rppUrl</a>", $request, $redirect);
